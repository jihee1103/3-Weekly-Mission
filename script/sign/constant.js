...
const INVALID_PASSWORD = '비밀번호를 확인해주세요';
...
export { EMPTY_EMAIL, INVALID_EMAIL, INVALID_PASSWORD, EMPTY_PASSWORD, NOT_MATCH_PASSWORD, CHECK_PASSWORD_FORMAT, DUPLICATED_EMAIL, CONFIRM_EMAIL, CONFIRM_PASSWORD_ALPHABET, CONFIRM_PASSWORD_NUMBER };