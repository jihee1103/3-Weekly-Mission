...
interface TKebabButtonProps extends ComponentPropsWithRef<'button'> {
  onClickHandler: VoidFunction;
}

const KebabButton = ({ onClickHandler, ...rest }: TKebabButtonProps) => {
  const onKebabButtonClickHandler = (e: MouseEvent<HTMLButtonElement>) => {
