...
import { kakaoJSAppKey } from "../../../api";
import BaseModal from "../BaseModal/BaseModal";
import "./EditOption.css";

function EditOption({ src, optionName, listName, userId, folderId }) {
  ...
  switch (optionName) {
      ...
      modalContent = (
        <>
          <div className="modal__folder-remove modal--remove">
            ...
            <span className="modal__folder-name">{listName}</span>
          </div>
    ...
    case "공유":
      ...
      const shareLink = hostName + `/shared?user=${userId}&folder=${folderId}`;
      ...
      modalContent = (
        <>
          <div className="modal__folder-share">
            ...
            <span className="modal__link">{listName}</span>
          </div>
